...
//             </div>
//             <div className="grid gap-2">
//                 <label htmlFor="body" className="text-sm leading-none font-medium select-none peer-disabled:cursor">
//                     Title:
//                 </label>
//             <textarea 
//             id="body"
...
export default function PostCreate() {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    axios.post("http://localhost:8000/api/posts", { username, phone, address })
      .then(() => navigate("/"))
      ...
      <div className="max-w-md w-full mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
            <h1 className="text-2xl font-bold text-white text-center">Create New Entry</h1>
          </div>
